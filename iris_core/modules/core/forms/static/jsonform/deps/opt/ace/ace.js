// IMPORTANT: the original ace.js file must be encapsulated in
// (function(require,define,requirejs) { ...})(undefined,undefined,undefined);
...
ace.define('ace/mouse/mouse_handler', ['require', 'exports', 'module' , 'ace/lib/event', 'ace/mouse/default_handlers', 'ace/mouse/default_gutter_handler', 'ace/mouse/mouse_event', 'ace/mouse/dragdrop'], function(require, exports, module) {
...
ace.define("text!ace/theme/textmate.css", [], ".ace-tm .ace_editor {\n" +
